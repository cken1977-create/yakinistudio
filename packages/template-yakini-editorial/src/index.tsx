// ═════════════════════════════════════════════════════════════════════════
// YAKINI EDITORIAL TEMPLATE
// ═════════════════════════════════════════════════════════════════════════
// The first design system shipped under Yakini Digital Infrastructure.
// Editorial restraint, dark-ground accents, gold/cream palette posture.
// Used by yakini.digital, theytowedmycar, pettit-luxe-group, px3-energy,
// and similar clients who adopt this house style.
//
// Bespoke clients (vizionz-sankofa, etc.) do NOT import from this template.
// They build custom components in apps/<client>/components/ from primitives.
//
// File location:
//   packages/template-yakini-editorial/src/index.tsx
//
// Imported as:
//   import { Hero, Navigation, Footer, ... } from '@yakini/template-yakini-editorial'
//
// Components included:
//   - <Navigation>      — Top nav with logo, links, mobile menu
//   - <Footer>          — Footer with Yakini Digital attribution
//   - <Hero>            — Home page hero (radial gradient, fade-in cascade)
//   - <ServiceCard>     — Service display card (italic numbers, top-stripe reveal)
//   - <PortfolioCard>   — Portfolio item card
//   - <ContactForm>     — Lead capture form (wired to /api/lead)
...
import { Button, hexToRgb } from '@yakini/ui-primitives'
...
// ───────────────────────────────────────────────────────────────────────
// FOOTER — Yakini Digital attribution per agency standard
// ───────────────────────────────────────────────────────────────────────
  ...
  return (
    <>
      <style>{`
        ...
        .yk-yakini-credit a:hover { color: var(--brand-bg); }
        @media (max-width: 768px) {
...
// ───────────────────────────────────────────────────────────────────────
// HERO — Home page hero with radial gradient and fade-in cascade
// SSR-safe getComputedStyle (typeof window guard preserved from prior fix)
// ───────────────────────────────────────────────────────────────────────
...
// ───────────────────────────────────────────────────────────────────────
// CONTACT FORM — wired to /api/lead
// ───────────────────────────────────────────────────────────────────────
